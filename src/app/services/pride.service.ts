...
export class PrideService{
  ...
  savePride(token, pride):Observable<any>{
    let params = JSON.stringify(pride);
		...
		return this._http.post(this.url+'savePride', params,{headers: headers});
  }
  ...
  applyPride(token, pride):Observable<any>{
    let params = JSON.stringify(pride);
		...
		return this._http.post(this.url+'applyPride', params,{headers: headers});
  }
  ...
  deleteRequest(token, userId):Observable<any>{
		...
		return this._http.delete(this.url+'deleteRequest/'+userId, {headers: headers});
  }
  ...
  joinPride(token, userId):Observable<any>{
		...
		return this._http.get(this.url+'joinPride/'+userId,{headers: headers});
  }
  ...
  getMembers(token, prideId):Observable<any>{
		...
		return this._http.get(this.url+'getMembers/'+prideId,{headers: headers});
  }
  ...
  deleteMember(token, userId: User):Observable<any>{
    let params = JSON.stringify(userId);
		...
		return this._http.put(this.url+'deleteMember', params, {headers: headers});
  }
}
