...
export class SalaComponent implements OnInit {
  ...
  chageColors() {
    if (this.sala.red_1)
      this.red1.nativeElement.style.color = this.sala.red_1.color;
    if (this.sala.red_2)
      this.red2.nativeElement.style.color = this.sala.red_2.color;
    if (this.sala.blue_1)
      this.blue1.nativeElement.style.color = this.sala.blue_1.color;
    if (this.sala.blue_2)
      this.blue2.nativeElement.style.color = this.sala.blue_2.color;
  }
