...
export class JuegoComponent implements OnInit{
	...
	comprobar(){
		...
		else if(this.b1 == true && this.b2 == true && this.b3 == true)alert("ganaste");
		else if(this.c1 == true && this.c2 == true && this.c3 == true)alert("ganaste");
		else if(this.a1 == true && this.b2 == true && this.c3 == true)alert("ganaste");
		else if(this.c1 == true && this.b2 == true && this.a3 == true)alert("ganaste");
		}
