...
export class AppComponent implements OnInit, DoCheck{
  ...
  openPopup_box(enter, leave){
    if(leave && !this.open_box) this.friends.nativeElement.style.color = "rgb(209, 209, 209)";
    if(enter) this.friends.nativeElement.style.color = "rgb(148, 148, 148)";
    else if(!leave){
      this.open_box = this.open_box == false ? true : false;
    
      if(this.open_box)this.friends.nativeElement.style.color = "rgb(148, 148, 148)";
  ...
  openPopup_user(enter, leave){
    if(leave && !this.open_user) this.user.nativeElement.style.color = "rgb(209, 209, 209)";
    
    if(enter) this.user.nativeElement.style.color = "rgb(148, 148, 148)"; 
    else if(!leave){
      this.open_user = this.open_user == false ? true : false;
    
      if(this.open_user)this.user.nativeElement.style.color = "rgb(148, 148, 148)";
  ...
  openPopup_clan(enter, leave){
    if(leave && !this.open_clan) this.clan.nativeElement.style.color = "rgb(209, 209, 209)";
    if(enter) this.clan.nativeElement.style.color = "rgb(148, 148, 148)";
    else if(!leave){
    this.open_clan = this.open_clan == false ? true : false;

    if(this.open_clan) this.clan.nativeElement.style.color = "rgb(148, 148, 148)";
  ...
  openPopup_update(enter, leave){
    if(leave && !this.open_update) this.edit.nativeElement.style.color = "rgb(209, 209, 209)";
    if(enter) this.edit.nativeElement.style.color = "rgb(148, 148, 148)";
    else if(!leave){
      this.open_update = this.open_update == false ? true : false;

      if(this.open_update) this.edit.nativeElement.style.color = "rgb(148, 148, 148)";
  ...
  clearColor(data){
    if(data !== 1) this.friends.nativeElement.style.color = "rgb(209, 209, 209)";
